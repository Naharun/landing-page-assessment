    ...
    return (
        <div className="image">
            <div className=" bg-[#1E1C49] bg-opacity-90">
                ...
                <h1 className="text-white mt-14 text-center pb-14">© Copyright 2024, Anonymous Tech Ltd, Designed and Developed by <span className="text-amber-500">Assessment User</span></h1>
            </div>
        </div>
    )
}
